...
var dummyUserImage = "{{url_for('static', filename='assets/images/users/user-dummy-img.jpg";
var dummyMultiUserImage = "{{url_for('static', filename='assets/images/users/multi-user.jpg";
...
var emojiPicker = new FgEmojiPicker({
    ...
    position: ["top", "right"],
    preFetch: true,
    dir: "{{url_for('static', filename='assets/js/pages/plugins/json",
