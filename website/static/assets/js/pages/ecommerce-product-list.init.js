...
var productListAllData = [
	{
		"id": 1,
		"product": {
			"img": "{{url_for('static', filename='assets/images/products/img-1.png')}}",
	...
	},
	{
		"id": 2,
		"product": {
			"img": "{{url_for('static', filename='assets/images/products/img-2.png')}}",
	...
	},
	{
		"id": 3,
		"product": {
			"img": "{{url_for('static', filename='assets/images/products/img-3.png')}}",
	...
	},
	{
		"id": 4,
		"product": {
			"img": "{{url_for('static', filename='assets/images/products/img-4.png')}}",
	...
	},
	{
		"id": 5,
		"product": {
			"img": "{{url_for('static', filename='assets/images/products/img-5.png')}}",
	...
	},
	{
		"id": 6,
		"product": {
			"img": "{{url_for('static', filename='assets/images/products/img-6.png')}}",
	...
	},
	{
		"id": 7,
		"product": {
			"img": "{{url_for('static', filename='assets/images/products/img-7.png')}}",
	...
	},
	{
		"id": 8,
		"product": {
			"img": "{{url_for('static', filename='assets/images/products/img-8.png')}}",
	...
	},
	{
		"id": 9,
		"product": {
			"img": "{{url_for('static', filename='assets/images/products/img-9.png')}}",
	...
	},
	{
		"id": 10,
		"product": {
			"img": "{{url_for('static', filename='assets/images/products/img-10.png')}}",
...
if (inputValueJson) {
	...
	inputValueJson.forEach(element => {
