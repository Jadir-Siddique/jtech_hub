...
xhttp.open("GET", "{{url_for('static', filename='assets/json/contact-list.json");
xhttp.send();
...
var tagHtmlValue = '';
tagInputFieldValue.forEach((tag, index) => {
...
function clearFields() {
    customerImg.src = "{{url_for('static', filename='assets/images/users/user-dummy-img.jpg";
    customerNameField.value = "";
    company_nameField.value = "";
    designationField.value = "";
    email_idField.value = "";
