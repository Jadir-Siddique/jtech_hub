...
if (vectorMapWorldMarkersColors) {
    var worldemapmarkers = new jsVectorMap({
        ...
        markers: [{
                ...
                style: {
                    image: "{{url_for('static', filename='assets/images/flags/us.svg",
                }
            },
            {
                name: "Russia",
                ...
                style: {
                    image: "{{url_for('static', filename='assets/images/flags/russia.svg",
                }
            },
            {
                name: "Spain",
                ...
                style: {
                    image: "{{url_for('static', filename='assets/images/flags/spain.svg",
                }
            },
            {
                name: "Italy",
                ...
                style: {
                    image: "{{url_for('static', filename='assets/images/flags/italy.svg",
                }
            },
            {
                name: "Germany",
                ...
                style: {
                    image: "{{url_for('static', filename='assets/images/flags/germany.svg",
                }
            },
        ],
        markerStyle: {
