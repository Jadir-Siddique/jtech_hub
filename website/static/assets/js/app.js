...
(function () {
	...
	function setLanguage(lang) {
		if (document.getElementById("header-lang-img")) {
			if (lang == "en") {
				document.getElementById("header-lang-img").src = "{{url_for('static', filename='assets/images/flags/us.svg";
			} else if (lang == "sp") {
				document.getElementById("header-lang-img").src = "{{url_for('static', filename='assets/images/flags/spain.svg";
			} else if (lang == "gr") {
				document.getElementById("header-lang-img").src = "{{url_for('static', filename='assets/images/flags/germany.svg";
			} else if (lang == "it") {
				document.getElementById("header-lang-img").src = "{{url_for('static', filename='assets/images/flags/italy.svg";
			} else if (lang == "ru") {
				document.getElementById("header-lang-img").src = "{{url_for('static', filename='assets/images/flags/russia.svg";
			} else if (lang == "ch") {
				document.getElementById("header-lang-img").src = "{{url_for('static', filename='assets/images/flags/china.svg";
			} else if (lang == "fr") {
				document.getElementById("header-lang-img").src = "{{url_for('static', filename='assets/images/flags/french.svg";
			}
	...
	function getLanguage() {
		...
		// request.open("GET", "{{url_for('static', filename='assets/lang/" + language + ".json");
		request.open("GET", "/static/assets/lang/en.json");
	...
	function twoColumnMenuGenerate() {
		...
		if (defaultValues && (isTwoColumn == "twocolumn" || defaultValues["data-layout"] == "twocolumn")) {
			...
			ul.innerHTML = '<a href="#" class="logo"><img src="{{url_for('static', filename='assets/images/logo-sm.png')}}" alt="" height="22"></a>';
